...
class CLIPSwinWithAttention(BaseModule):
    def __init__(self,
        ...
        # input_resolution=512
        width=32
        embed_dim = width * 24  # the ResNet feature dimension
        self.glpool = GlobalLocalPool(embed_dim, output_dim)
    ...
    def forward(self, x):
        ...
        x_global, x_local = self.glpool(out)
